...
\begin{document}
  ...
  We implemented Prim's algorithm(eager version), using
  an indexed priority queue. It is used for finding the
  edge with the minimum weight, which is connecting the
  MST to the vertices not belonging to the MST. The total
